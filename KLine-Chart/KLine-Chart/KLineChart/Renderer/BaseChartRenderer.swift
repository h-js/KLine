...
class BaseChartRenderer {
    ...
    func drawTopText(context _: CGContext, curPoint _: KLineModel) {}
    ...
    // 画图表
    func drawChart(context _: CGContext, lastPoint _: KLineModel?, curPoint _: KLineModel, curX _: CGFloat) {}
